...
bucket = storage_client.bucket("mlop")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "mlproject-465617.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://mlop/bank_campaign_data/bank-additional.csv"
    model_name='xgboost'
